...
**Database:** `RCL_YIELD_OPTIMIZATION`
...
> Royal Caribbean International operates a fleet of 10 ships across 4 classes and 6 global regions, carrying millions of guests annually. Every sailing is a perishable asset -- an empty cabin on departure day is revenue lost forever. The revenue management challenge: set the right price, for the right cabin, on the right ship, for the right guest, at the right time.
>
> Today we'll show how Royal Caribbean's revenue management team uses **Snowflake Intelligence** with purpose-built AI agents to ask natural-language questions across yield data, guest profiles, pricing funnels, and airline partner signals -- and get instant, data-driven answers they can act on.
...
```
> *Harmony is a 6,780-passenger Oasis-class ship -- the largest revenue generator. Tracking its trend reveals whether the fleet's anchor is holding.*

**3. Ship class comparison**
```
Which ship class has the best yield optimization?
```
> *Compares Oasis, Quantum, Voyager, and Freedom classes. Reveals whether mega-ships or smaller vessels are producing better per-passenger economics.*
...
```
> *Maps the Crown & Anchor Society pyramid: Blue, Gold, Platinum, Diamond, Diamond+. The shape of this pyramid drives retention strategy.*
...
```
Can you give me pricing recommendations for Harmony of the Seas?
```
> *Breaks down Harmony's pricing by cabin class with conversion rates and average prices. Generates specific recommendations: "lower by 5-10%", "competitive", or "strong -- consider premium positioning".*
...
```
> *Different ports serve different markets. Miami guests may have different price sensitivity than Boston or Seattle guests. This reveals port-level pricing gaps.*
...
> "In this demo we showed how Royal Caribbean uses Snowflake Intelligence to:
>
> 1. **Monitor fleet yield** in real time across 10 ships and 6 regions
> 2. **Understand guest value** through 360-degree profiles with Crown & Anchor Society loyalty data
...
**Regions:** Caribbean, Alaska, Europe, Mexico, Bahamas, Bermuda
**Loyalty Program:** Crown & Anchor Society (Blue > Gold > Platinum > Diamond > Diamond+)
