...
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT CRUISE_YIELD_OPTIMIZATION.AGENTS.CRUISE_YIELD_ANALYST;

-- 2. Guest Intel
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT CRUISE_YIELD_OPTIMIZATION.AGENTS.CRUISE_GUEST_INTEL;

-- 3. Pricing Copilot
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT CRUISE_YIELD_OPTIMIZATION.AGENTS.CRUISE_PRICING_COPILOT;

-- 4. Partner Insights
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT CRUISE_YIELD_OPTIMIZATION.AGENTS.CRUISE_PARTNER_INSIGHTS;

-- 5. Unified Yield Optimization Agent
ALTER SNOWFLAKE INTELLIGENCE SNOWFLAKE_INTELLIGENCE_OBJECT_DEFAULT
    ADD AGENT CRUISE_YIELD_OPTIMIZATION.AGENTS.CRUISE_YIELD_OPTIMIZATION_AGENT;
